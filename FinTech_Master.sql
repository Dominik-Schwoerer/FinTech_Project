...
FROM CROSSTAB($$
	...
	$$) AS ct (
		...
		"Webinar" NUMERIC)
ORDER BY sales_month ASC;
-- FULL DISCALIMER: RESULTS ARE NOT AS EXPECTED WITH SIGNED_VALUE NOT BEEING CORRECTLY ASSIGNED TO THE CUSTOMER_ACQUISITION_CHANNEL WITHIN A GIVEN MONTH. ERROR COULD NOT BE LOCATED, HAPPY FOR ANY FEEDBACK.
